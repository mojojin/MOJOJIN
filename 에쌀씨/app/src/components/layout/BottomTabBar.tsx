...
const mainTabs = [
  ...
  { href: '/marathons', label: '마라톤', icon: (active: boolean) => (
    <svg className={`w-5 h-5 ${active ? 'text-gray-955' : 'text-gray-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={active ? 2.5 : 1.8}>
...
export default function BottomTabBar() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md border-t border-gray-100 safe-area-bottom shadow-[0_-2px_10px_rgba(0,0,0,0.03)]">
