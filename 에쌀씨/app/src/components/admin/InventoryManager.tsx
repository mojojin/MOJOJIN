  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-xl font-bold text-gray-900">비품 관리</h2>
          <p className="text-xs text-gray-500">크루 공용 자산을 관리합니다.</p>
        </div>
        <button onClick={() => openForm()} className="rounded-2xl bg-[#CCFF00] border border-[#b8e600] px-4 py-2 text-xs font-bold text-gray-900 hover:bg-[#b8e600] active:scale-95 transition-all">
          물품 추가
        </button>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-10 bg-gray-50 rounded-2xl border border-gray-200 text-gray-500 text-xs">등록된 비품이 없습니다.</div>
      ) : (
