        ...
        win.document.write(`
          ...
          <html>
            <head>
              ...
              <style>
                body { margin:0; background:#111; color:#fff; display:flex; flex-direction:column; align-items:center; justify-content:center; min-height:100vh; font-family:sans-serif; text-align:center; padding:70px 16px 30px; box-sizing:border-box; }
                img { max-width:100%; max-height:70vh; height:auto; border-radius:16px; box-shadow:0 8px 30px rgba(0,0,0,0.8); margin-bottom:16px; }
                p { font-size:15px; font-weight:bold; color:#CCFF00; word-break:keep-all; }
